...
from app.engine.phase_1_11 import DEFAULT_OUTPUT_DIR, run_phase_1_11
...
async def _run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        write_json(output_dir / "phase_1_11_summary.json", summary)
    finally:
        await pool.close()
    return 0
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Phase 1.11 historical signal event ledger repair audit.")
