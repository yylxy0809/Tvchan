...
from app.engine.phase_1_12 import DEFAULT_OUTPUT_DIR, run_phase_1_12
...
async def _run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        write_json(output_dir / "phase_1_12_summary.json", summary)
    finally:
        await pool.close()
    return 0
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Phase 1.12 daily setup policy and 30F downstream diagnostics.")
